  ...
  return (
    <>
      <footer className="bg-gray-800">
        <div className="max-w-7xl mx-auto container py-16 xl:px-20 lg:px-12 sm:px-6 px-4">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 md:gap-8">
            <div className="flex flex-col flex-shrink-0">
              <div className="dark:text-white">
                <h1 className="text-2xl font-bold dark:hidden">SC MOVIES</h1>
                <h1 className="text-2xl font-bold hidden dark:block">
                  SC MOVIES
                </h1>
              </div>
              <p className="text-sm leading-none text-gray-800 mt-4 dark:text-white">
                Copyright © 2021 SC Movies
              </p>
              <p className="text-sm leading-none text-gray-800 mt-4 dark:text-white">
                All rights reserved
              </p>
